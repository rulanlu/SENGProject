 ...
 * As well as accepting/denying the application
 * @author Rulan Lu
 *
 */
	    ...
	    scholarships.addMouseListener(new MouseAdapter() {
	        	...
	        	public void mouseClicked(MouseEvent e) {
	        		...
	        		if (scholarships.getValueAt(scholarships.getSelectedRow(), 0) != null) {
		        		String text = (String)table.getValueAt(i, 0) + "'s application for " + (String)table.getValueAt(i, 1);
		        		RespondToApplication response = new RespondToApplication((String)table.getValueAt(i, 0), (String)table.getValueAt(i, 1));
