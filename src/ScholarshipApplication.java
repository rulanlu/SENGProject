...
public class ScholarshipApplication extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ScholarshipApplication frame = new ScholarshipApplication(name, date, ID, username, GPA, amount,
	 ...
	 */
	public ScholarshipApplication(String sname, String sdate, String sid, String suser, String sgpa, String samount,
			String sfac, String supp) {
		...
		// set average GPA of all applicants to show student
		if (num > 0) {
		...
		applyButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (studentGPA < Double.parseDouble(GPA)) {
					JOptionPane.showMessageDialog(null, "You are not eligible for this scholarship (GPA)", null,
							JOptionPane.PLAIN_MESSAGE);
				} else if (!(studentFaculty.equals(faculty)) && !(faculty.equals("All"))) {
					JOptionPane.showMessageDialog(null, "You are not eligible for this scholarship (Faculty)", null,
							JOptionPane.PLAIN_MESSAGE);
				} else if (studentAwarded.equals("Yes")) {
					JOptionPane.showMessageDialog(null,
							"You have already been awarded a scholarship! Each student can only be awarded one scholarship max",
					...
					try {
						...
						while (in.hasNextLine()) {
							...
							if (in.nextLine().equals(appendApplication)) {
								setVisible(false);
								JOptionPane.showMessageDialog(null, "You've already applied for this scholarship", null,
										JOptionPane.PLAIN_MESSAGE);
								exists = true;
								break;
							}
						...
						if (exists == false) {
							...
							// otherwise, finish application
								...
								setVisible(false);
								JOptionPane.showMessageDialog(null, "Application successful", null,
										JOptionPane.PLAIN_MESSAGE);
							}
						}
					} catch (IOException m) {
